...
<html lang="en">
	<head>
		...
		<meta name="description" content="We are trying to help refugees that are struggling in cold weather in Calais and in refugee camps in the UK.">
		<meta name="author" content="Ondrej Rafaj - Ridiculous Innovations">
		<link rel="icon" href="ico/favicon.ico">
		<title>Give with Smile - Help us help!</title>
		<!-- CSS Plugins -->
	...
	<body data-spy="scroll" data-target=".navbar" data-offset="71">
		...
		<div class="wrapper">
				...
				<div class="container">
					...
					<div id="navbar" class="collapse navbar-collapse">
						<ul class="nav navbar-nav navbar-right ">
							...
							<li><a href="#need">What do we need!</a></li>
				...
				<div class="container">
					<div class="row">
						<div class="col-xs-12">
							...
							<a href="#donate" class="hero__btn btn btn-lg btn-link animated fadeInUp delay_2">Donate</a>
						</div>
					</div>
				</div>
			</div>
					...
					<div class="row">
						<div class="row-same-height">
							<div class="col-sm-5 col-sm-height col-middle">
								<h4 class="heading heading_left">Fully responsive</h4>
								<p class="heading__sub">
									Sed erat tortor, bibendum at sem in, malesuada ultricies eros. Integer maximus scelerisque sapien ut porta. Nulla tempor rutrum enim vitae lobortis. Quisque varius, ante in aliquet semper.
								</p>
								<a href="#" class="btn btn-default heading__btn">Primary action</a>
							</div>
							<div class="col-sm-7 col-sm-height col-middle">
								<img src="img/showcase.png" alt="..." class="img-responsive">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="container">
					<div class="row">
						<div class="col-xs-12 col-sm-8 col-md-6 col-sm-offset-2 col-md-offset-3">
							<h4 class="heading">Get started now</h4>
							<p class="heading__sub">
								Phasellus gravida sem magna, nec maximus quam tincidunt non. Cras molestie nec libero nec hendrerit. Morbi imperdiet, lorem nec rhoncus vehicula, quam orci finibus dolor, non malesuada orci turpis eleifend neque.
							</p>
							<a href="#contact" class="btn btn-lg btn-primary heading__btn wow fadeInUp">Primary action</a>
						</div>
					</div>
				</div>
			</div>
			...
			<!-- / .section -->
			<div class="section section_alt section_download" id="donate">
				<div class="container">
					<div class="row">
						<div class="col-xs-12">
					...
					<div class="row">
						<form name="_xclick" action="https://www.paypal.com/uk/cgi-bin/webscr" method="post" class="col-lg-4 col-lg-offset-4 col-sm-10 col-sm-offset-1" style="text-align: center;">
							...
							<p>
								<input type="text" name="amount" value="10.00" placeholder="10" class="form-control" />
							</p>
							<p>
								<select name="currency_code" class="form-control">
									<option value="GBP">GBP - Pounds Sterling</option>
									<option value="GBP">EUR - Euro</option>
									<option value="GBP">CZK - Koruna Česká</option>
								</select>
							</p>
							<p>
			...
			<div class="section" id="inspiration">
				<div class="container">
					<div class="row">
						<div class="col-xs-12">
							<h4 class="heading">Inspiration</h4>
							<p class="heading__sub">
								Take a look what we need to help people through the winter. You can either donate your old stuff or buy something new ... it really costs peanuts!
							</p>
						</div>
					</div>
				</div>
				<div class="portfolio__items">
					<div class="col-xs-6 col-sm-4 col-md-3">
						<div class="portfolio__item">
							<div class="portfolio-item__img">
								<a href="img/portfolio_1.jpg" data-lightbox="portfolio">
									<img src="img/portfolio_1.jpg" class="img-responsive" alt="Emergency Sleeping Shelter">
					...
					<div class="col-xs-6 col-sm-4 col-md-3">
						<div class="portfolio__item">
							<div class="portfolio-item__img">
								<a href="img/portfolio_2.jpg" data-lightbox="portfolio">
									<img src="img/portfolio_2.jpg" class="img-responsive" alt="...">
									<div class="portfolio-item__mask">
										<div class="portfolio-item-mask__content">
											<div class="portfolio-item-mask__title">
												Tents
					...
					<div class="col-xs-6 col-sm-4 col-md-3">
						<div class="portfolio__item">
							<div class="portfolio-item__img">
								<a href="img/portfolio_3.jpg" data-lightbox="portfolio">
									<img src="img/portfolio_3.jpg" class="img-responsive" alt="...">
									<div class="portfolio-item__mask">
										<div class="portfolio-item-mask__content">
											<div class="portfolio-item-mask__title">
												Sleeping bags
					...
					<div class="col-xs-6 col-sm-4 col-md-3">
						<div class="portfolio__item">
							<div class="portfolio-item__img">
								<a href="img/portfolio_4.jpg" data-lightbox="portfolio">
									<img src="img/portfolio_4.jpg" class="img-responsive" alt="...">
									<div class="portfolio-item__mask">
										<div class="portfolio-item-mask__content">
											<div class="portfolio-item-mask__title">
												Cooking equipment
					...
					<div class="col-xs-6 col-sm-4 col-md-3">
						<div class="portfolio__item">
							<div class="portfolio-item__img">
								<a href="img/portfolio_5.jpg" data-lightbox="portfolio">
									<img src="img/portfolio_5.jpg" class="img-responsive" alt="...">
									<div class="portfolio-item__mask">
										<div class="portfolio-item-mask__content">
											<div class="portfolio-item-mask__title">
												Camping Mats
					...
					<div class="col-xs-6 col-sm-4 col-md-3">
						<div class="portfolio__item">
							<div class="portfolio-item__img">
								<a href="img/portfolio_6.jpg" data-lightbox="portfolio">
									<img src="img/portfolio_6.jpg" class="img-responsive" alt="...">
									<div class="portfolio-item__mask">
										<div class="portfolio-item-mask__content">
											<div class="portfolio-item-mask__title">
												First Aid Kits
					...
					<div class="col-xs-6 col-sm-4 col-md-3">
						<div class="portfolio__item">
							<div class="portfolio-item__img">
								<a href="img/portfolio_7.jpg" data-lightbox="portfolio">
									<img src="img/portfolio_7.jpg" class="img-responsive" alt="...">
									<div class="portfolio-item__mask">
										<div class="portfolio-item-mask__content">
											<div class="portfolio-item-mask__title">
					...
					<div class="col-xs-6 col-sm-4 col-md-3">
						<div class="portfolio__item">
							<div class="portfolio-item__img">
								<a href="img/portfolio_8.jpg" data-lightbox="portfolio">
									<img src="img/portfolio_8.jpg" class="img-responsive" alt="...">
									<div class="portfolio-item__mask">
										<div class="portfolio-item-mask__content">
											<div class="portfolio-item-mask__title">
												Food
			...
			<div class="section" id="team">
				<div class="container">
					<div class="row">
						<div class="col-xs-12">
							<h4 class="heading">Meet us!</h4>
							<p class="heading__sub">
								Who are we? Just a regular bunch of lads living across Europe who got together to help. We are tired of endlessly fighting xenophobia and racism on social media and want to take on all the people that have told us to <strong><i>"fuck off and help them yourself!"</i></strong> ... well, here we go!
							</p>
						</div>
					</div>
					<div class="row">
			...
			<!-- SKILLS
				...
				<div class="section" id="skills">
				  <div class="container">
				    <div class="row">
				      <div class="col-xs-12">
				        <h4 class="heading">Our key skills</h4>
				        <p class="heading__sub">
				          Maecenas varius fringilla eros. Ut feugiat sagittis porta. Nulla est sapien, eleifend a interdum et.. <br />Cum sociis natoque penatibus et magnis dis parturient montes, nascetur.
				        </p>
				      </div>
				    </div>
				    <div class="row">
				      ...
				      <div class="col-xs-6 col-sm-3 col-md-2 col-md-offset-2">
				        <div class="skills__item js-skills__item_first">
				          <div class="skills-item__title">HTML</div>
				      ...
				      <div class="col-xs-6 col-sm-3 col-md-2">
				        <div class="skills__item">
				          <div class="skills-item__title">CSS</div>
				      ...
				      <div class="col-xs-6 col-sm-3 col-md-2">
				        <div class="skills__item">
				          <div class="skills-item__title">JS</div>
				      ...
				      <div class="col-xs-6 col-sm-3 col-md-2">
				        <div class="skills__item">
				          <div class="skills-item__title">PHP</div>
				...
				<div class="container">
					<div class="row">
						<div class="col-xs-12">
							...
							<h4 class="heading">What other think about this project?</h4>
						</div>
					</div>
					<div class="row">
						<div class="col-md-10 col-md-offset-1">
							...
							<div id="review__carousel" class="owl-carousel owl-theme">
								<div class="item">
									<div class="review__item">
										<div class="review-item__quot">
											Fusce eget mattis diam. In interdum, ipsum eget convallis semper, nulla lorem venenatis tellus, at feugiat sapien leo eget felis. Cras nec finibus ante. Proin ac nulla pellentesque, laoreet mauris.
										</div>
										<div class="review-item__about">
											<div class="review-item-about__avatar">
												<img class="img-responsive" src="img/author_1.jpg" alt="...">
											</div>
											<div class="review-item-about__content">
												<div class="review-item-about__name">Jane Roe</div>
												<div class="review-item-about__position">Front-end developer</div>
											</div>
											<div class="clearfix"></div>
										</div>
									</div>
								...
								<div class="item">
									<div class="review__item">
										...
										<div class="review-item__about">
											<div class="review-item-about__avatar">
												<img class="img-responsive" src="img/author_2.jpg" alt="...">
											</div>
											<div class="review-item-about__content">
												<div class="review-item-about__name">John Doe</div>
												<div class="review-item-about__position">Front-end developer</div>
											</div>
											<div class="clearfix"></div>
										</div>
								...
								<div class="item">
									<div class="review__item">
										...
										<div class="review-item__about">
											<div class="review-item-about__avatar">
												<img class="img-responsive" src="img/author_3.jpg" alt="...">
											</div>
											<div class="review-item-about__content">
												<div class="review-item-about__name">Elena Doe</div>
												<div class="review-item-about__position">Front-end developer</div>
											</div>
											<div class="clearfix"></div>
										</div>
								...
								<div class="item">
									<div class="review__item">
										...
										<div class="review-item__about">
											<div class="review-item-about__avatar">
												<img class="img-responsive" src="img/author_4.jpg" alt="...">
											</div>
											<div class="review-item-about__content">
												<div class="review-item-about__name">Kate Doe</div>
												<div class="review-item-about__position">Front-end developer</div>
											</div>
											<div class="clearfix"></div>
										</div>
								...
								<div class="item">
									<div class="review__item">
										...
										<div class="review-item__about">
											...
											<div class="review-item-about__content">
												<div class="review-item-about__name">James Miles</div>
												<div class="review-item-about__position">Front-end developer</div>
											</div>
											<div class="clearfix"></div>
										</div>
						...
						<div class="col-xs-12">
							...
							<form class="form-inline form_alt subscribe__form">
								<div class="form-group">
									...
									<input type="text" class="form-control input-lg" id="subscribe__name" placeholder="Enter your name">
								</div>
								<div class="form-group">
									<label class="sr-only" for="subscribe__email">Email address</label>
									<input type="email" class="form-control input-lg" id="subscribe__email" placeholder="Enter your email">
								</div>
			...
			<div class="container" id="contact">
				<div class="row">
					<div class="col-xs-12">
						...
						<p class="heading__sub">
							Do you have any questions about this project? Are you a charity that would like to get involved or would you like to get involved personally? Let us know!!!
						</p>
					</div>
				</div>
				<div class="row">
			...
			<footer>
				<div class="container">
					<div class="row">
						<div class="col-sm-6">
							&copy; <?= date('Y'); ?> ridiculous-innovations.com; All Rights Reserved.
						</div>
						<div class="col-sm-6">
